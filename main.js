...
global.channelLink = "https://whatsapp.com/channel/0029VbC4cltLNSa3oAbk8d2l";
global.ytch = "MODSxTOOLS";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbC4cltLNSa3oAbk8d2l'
                }, { quoted: message });
                return;
